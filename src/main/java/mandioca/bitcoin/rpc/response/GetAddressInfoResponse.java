...
public class GetAddressInfoResponse extends BitcoindRpcResponse {


}

/*
$BITCOIN_HOME/bitcoin-cli -testnet help getaddressinfo
  ...
  "labels"                      (object) Array of labels associated with the address.
    [
      { (json object of label data)
        ...
        "purpose": "string" (string) Purpose of address ("writeNetworkEnvelope" for sending address, "receive" for receiving address)
      },...
    ]
}
